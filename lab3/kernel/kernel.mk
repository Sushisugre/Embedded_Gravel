...
KOBJS := assert.o main.o time_driver.o raise.o call_user.o \
		read.o write.o exit.o time.o sleep.o swi_handler.o c_swi_handler.o irq_handler.o c_irq_handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
