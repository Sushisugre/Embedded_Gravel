...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o enter_user_mode.o irq_handler.o time_driver.o swi_handler.o c_swi_handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
