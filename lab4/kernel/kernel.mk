...
KOBJS := assert.o main.o enter_user_mode.o math.o memcheck.o raise.o ctype.o hexdump.o device.o irq_handler.o time_driver.o swi_handler.o c_swi_handler.o
